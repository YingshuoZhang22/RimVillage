...
public class EntityInit {
    ...
    public static final RegistryObject<EntityType<RimVillagerEntity>> RIMVILLAGER_ENTITY = ENTITIES.register("rimvillager", () -> EntityType.Builder.create(RimVillagerEntity::new, EntityClassification.MISC).size(1.5F, 3).build("rimvillager"));
